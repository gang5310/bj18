...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey('tuser.User', verbose_name='用户',on_delete=models.CASCADE,)
    addr = models.ForeignKey('tuser.Address', verbose_name='地址',on_delete=models.CASCADE,)
